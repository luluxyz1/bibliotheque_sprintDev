                ...
                <table class="table-auto">
                    ...
                    <tbody>
                        <?php foreach ($query_librarians as $librarian) : ?>
                            <tr>
                                <form action="../includes/update_librarians.inc.php" method="post">
                                    <td class="border ">
                                        <input type="text" name="id_bibliothecaire" value="<?= $librarian['id_bibliothecaire'] ?>" readonly>
                                    </td>
                                    <td class="border ">
                                ...
                                <td class="border">
                                    <form action="../includes/delete_librarians.inc.php" method="post">
                                        <input type="hidden" name="id_bibliothecaire" value="<?= $librarian['id_bibliothecaire'] ?>">
